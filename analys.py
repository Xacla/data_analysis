...
if flag==0:
    ...
    data1=np.loadtxt('人工データ/一様乱数/rondom_make1.csv',delimiter=",")
    data2=np.loadtxt('人工データ/一様乱数/rondom_make2.csv',delimiter=',')
    data3=np.loadtxt('人工データ/一様乱数/rondom_make3.csv',delimiter=',')
    data4=np.loadtxt('人工データ/一様乱数/rondom_make4.csv',delimiter=',')
